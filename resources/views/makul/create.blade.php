                         ...
                         <div class="form-group">
                            <div class="from row">
                                <div class="col">
                                    ...
                                    <input type="text" class="form-control" name="kd_makul" placeholder="Masukkan Kode Mata Kuliah">
                                </div>
                                <div class="col">
                                    <label>Nama Mata Kuliah</label>
                                    <input type="text" class="form-control" name="nama_makul" placeholder="Masukkan Nama Mata Kuliah">
                                </div>
                                <div class="col">
                                    <label>SKS</label>
